...
albert.password = "foo"
cecilia = Citizen.create :name => "Cecilia Dönitz", :email => "cecilia@example.org"
cecilia.password = "foo"
edwin = Citizen.create :name => "Edwin Forbnitz", :email => "edwin@example.org"
edwin.password = "foo"
gunilla = Citizen.create :name => "Gunilla Holm", :email => "gunilla@example.org"
gunilla.password = "foo"
ingemar = Citizen.create :name => "Ingemar Jansson", :email => "ingemar@example.org"
ingemar.password = "foo"
kristina = Citizen.create :name => "Kristina Lazarus", :email => "kristina@example.org"
kristina.password = "foo"
mikael = Citizen.create :name => "Mikael Namaste", :email => "mikael@example.org"
mikael.password = "foo"
octavia = Citizen.create :name => "Octavia Pengler", :email => "octavia@example.org"
octavia.password = "foo"
quintus = Citizen.create :name => "Quintus Rutger", :email => "quintus@example.org"
quintus.password = "foo"
sara = Citizen.create :name => "Sara Tempelhof", :email => "sara@example.org"
sara.password = "foo"
uwe = Citizen.create :name => "Uwe Vogel", :email => "uwe@example.org"
uwe.password = "foo"
xanada = Citizen.create :name => "Xanada Yong", :email => "xanada@example.org"
xanada.password = "foo"
zeno = Citizen.create :name => "Zeno Åkesson", :email => "zeno@example.org"
zeno.password = "foo"
arla = Citizen.create :name => "Ärla Öberg", :email => "arla@example.org"
arla.password = "foo"
