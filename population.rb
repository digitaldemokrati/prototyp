...
albert = Citizen.create :name => "Albert Bernstein"
cecilia = Citizen.create :name => "Cecilia Dönitz"
edwin = Citizen.create :name => "Edwin Forbnitz"
gunilla = Citizen.create :name => "Gunilla Holm"
ingemar = Citizen.create :name => "Ingemar Jansson"
kristina = Citizen.create :name => "Kristina Lazarus"
mikael = Citizen.create :name => "Mikael Namaste"
octavia = Citizen.create :name => "Octavia Pengler"
quintus = Citizen.create :name => "Quintus Rutger"
sara = Citizen.create :name => "Sara Tempelhof"
uwe = Citizen.create :name => "Uwe Vogel"
xanada = Citizen.create :name => "Xanada Yong"
zeno = Citizen.create :name => "Zeno Åkesson"
arla = Citizen.create :name => "Ärla Öberg"
