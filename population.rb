...
legalisera = Proposition.create :citizen => zeno, :title => "Legalisera cannabis", :text => "Cannabis är en relativt harmlös drog. De skador som drogen orsakar bleknar i jämförelse med de skador som orsakas av förbudet.\nStaten har ingen rätt att förfölja de tusentals människor som väljer att använda cannbis.\nDärför bör cannabis legaliseras, regleras och beskattas på ett sätt som liknar hur man idag hanterar alkohol."
